    ...
    <section className='text-center min-h-screen w-[350px] flex flex-col place-content-around items-center'>
        ...
        <section className='flex flex-col gap-y-10'>
            ...
            <section className='grid grid-cols-3 items-center place-content-around gap-x-2'>
                ...
                <div  onClick={handlevel} className='bg-white/25 backdrop-blur-lg rounded-2xl flex flex-col items-center gap-y-3 hover:shadow-[0_3px_0px_rgba(0,0,0,0.3)] rounded-2xl p-2'>
                    <img className='object-cover h-10 w-10' src={"/images/wind.svg"} alt="" />
                    <span>{vel? velm_s: velkm_h}{vel? " m/s": " km/h"}</span>
                </div>

                <div className='bg-white/25 backdrop-blur-lg rounded-2xl flex flex-col items-center gap-y-3  rounded-2xl p-2'>
                    <img className='object-cover h-10 w-10' src={"/images/humidity.svg"} alt="" />
                    <span>{weatherInfo?.main.humidity} %</span>
                </div>

                <div onClick={handlepre} className='bg-white/25 backdrop-blur-lg rounded-2xl flex flex-col items-center gap-y-3 hover:shadow-[0_3px_0px_rgba(0,0,0,0.3)] rounded-2xl p-2'>
